...
--
-- Table structure for table `tiposmaterial`
--

DROP TABLE IF EXISTS `tiposmaterial`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `tiposmaterial`
--

LOCK TABLES `tiposmaterial` WRITE;
/*!40000 ALTER TABLE `tiposmaterial` DISABLE KEYS */;
INSERT INTO `tiposmaterial` VALUES (1,'Electronica'),(2,'Electricidad'),(3,'Ferreteria');
/*!40000 ALTER TABLE `tiposmaterial` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-05-15 20:25:05
